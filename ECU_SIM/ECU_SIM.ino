...
void post_CAN(){
 ...
 //   unsigned char vinBuf[8];
    unsigned char canFlow[8] = {0x30, 0x10, 0x55, 0x00, 0x00, 0x00, 0x00, 0x00};
    unsigned char vin[7] =                {4, 65, 12, 123, 224, 185, 147};
   unsigned  char CoolantTemp[7] =        {4, 65, 5, CoolantTempT, 0, 185, 147};  
    unsigned char rpm[7] =                {4, 65, 12, RPM, 224, 185, 147};
    unsigned char vspeed[7] =             {4, 65, 13, Speed, 224, 185, 147};
    ...
    if(CAN_MSGAVAIL == CAN.checkReceive())  
    {
      ...
      CAN.readMsgBuf(&len, buf); 
        ...
        if(BuildMessage=="2,9,2,0,0,0,0,0,") {CAN.sendMsgBuf(0x7E8, 0, 8, canFlow);}
